...
class CO2RR(data.MoleculeDataset):
    ...
    def __init__(self, path, verbose=1, **kwargs):
        ...
        self.target_fields = ["General effects"]

        filename = path + "CO2RR.csv"

        self.load_csv(filename, smiles_field="SMILES", target_fields=self.target_fields, verbose=verbose, **kwargs)
...
solver = core.Engine(task, train_set, valid_set, test_set, optimizer, gpus=[0], batch_size=256)
